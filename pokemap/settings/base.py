...
SECRET_KEY = '_+(jt3c$%as%0%6i$aluq)90+%!+wc#&e_tew(yye8n0*7#srb'
...
PGOAPI_CONFIG = {
    'auth_service': os.environ.get('PGOAPI_AUTH_SERVICE','ptc'),
    'username': os.environ.get('PGOAPI_USERNAME',''),
    'password': os.environ.get('PGOAPI_PASSWORD',''),
}
